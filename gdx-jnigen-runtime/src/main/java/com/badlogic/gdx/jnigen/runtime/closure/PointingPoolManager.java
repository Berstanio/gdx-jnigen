...
public class PointingPoolManager {
    ...
    private PointingPoolManager (PointingPoolManager template) {
        this.pools = template.pools;
        this.frameSize = template.frameSize;
        this.frame = new Pointing[template.frameSize];
        this.count = 0;
    }

    public PointingPoolManager newThreadLocalClone () {
        return new PointingPoolManager(this);
    }
